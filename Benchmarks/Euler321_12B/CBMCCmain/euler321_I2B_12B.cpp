...
void euler321_I2B_12B_step(RT_MODEL_euler321_I2B_12B_T* euler321_I2B_12B_M, real_T euler321_I2B_12B_U_phi, real_T euler321_I2B_12B_U_theta, real_T euler321_I2B_12B_U_psi, real_T euler321_I2B_12B_U_Vi[3], real_T euler321_I2B_12B_U_Inport, real_T euler321_I2B_12B_Y_DCM321[9], real_T euler321_I2B_12B_Y_Vb[3], real_T euler321_I2B_12B_Y_outTheta[3], real_T euler321_I2B_12B_Y_outGamma[3], boolean_T* euler321_I2B_12B_Y_outR1) {
    ...
    for (i_0 = 0;BitmapCov::CondAndMCDCRecord(BitmapCov::CondAndMCDCRecord(i_0 < 3, 0, 1, 0), -1, 0, 0);i_0++) {
        BitmapCov::branchBitmap[0] = 1;
        for (i = 0;BitmapCov::CondAndMCDCRecord(BitmapCov::CondAndMCDCRecord(i < 3, 2, 1, 1), -3, 0, 1);i++) {
            BitmapCov::branchBitmap[1] = 1;
            rtb_Product1_c_tmp = 3 * i_0 + i;
            rtb_Product1_b[rtb_Product1_c_tmp] = 0.0;
            rtb_Product1_b[rtb_Product1_c_tmp] += rtb_Product1_i0[3 * i_0] * euler321_I2B_12B_Y_DCM321[i];
            rtb_Product1_b[rtb_Product1_c_tmp] += rtb_Product1_i0[3 * i_0 + 1] * euler321_I2B_12B_Y_DCM321[i + 3];
            rtb_Product1_b[rtb_Product1_c_tmp] += rtb_Product1_i0[3 * i_0 + 2] * euler321_I2B_12B_Y_DCM321[i + 6];
        }
    ...
    for (i_0 = 0;BitmapCov::CondAndMCDCRecord(BitmapCov::CondAndMCDCRecord(i_0 < 3, 4, 1, 2), -5, 0, 2);i_0++) {
        ...
        for (i = 0;BitmapCov::CondAndMCDCRecord(BitmapCov::CondAndMCDCRecord(i < 3, 6, 1, 3), -7, 0, 3);i++) {
            ...
            euler321_I2B_12B_Y_DCM321[rtb_Product1_c_tmp] += rtb_Product1_b[3 * i_0] * rtb_Product1_i0[i];
            euler321_I2B_12B_Y_DCM321[rtb_Product1_c_tmp] += rtb_Product1_b[3 * i_0 + 1] * rtb_Product1_i0[i + 3];
            euler321_I2B_12B_Y_DCM321[rtb_Product1_c_tmp] += rtb_Product1_b[3 * i_0 + 2] * rtb_Product1_i0[i + 6];
        }
    ...
    for (i_0 = 0;BitmapCov::CondAndMCDCRecord(BitmapCov::CondAndMCDCRecord(i_0 < 3, 8, 1, 4), -9, 0, 4);i_0++) {
        ...
        for (i = 0;BitmapCov::CondAndMCDCRecord(BitmapCov::CondAndMCDCRecord(i < 3, 10, 1, 5), -11, 0, 5);i++) {
            BitmapCov::branchBitmap[9] = 1;
            rtb_Product1_c_tmp = 3 * i_0 + i;
            rtb_VectorConcatenate[rtb_Product1_c_tmp] = 0.0;
            rtb_VectorConcatenate[rtb_Product1_c_tmp] += rtb_Product1_i0[3 * i_0] * rtb_Product1_b[i];
            rtb_VectorConcatenate[rtb_Product1_c_tmp] += rtb_Product1_i0[3 * i_0 + 1] * rtb_Product1_b[i + 3];
            rtb_VectorConcatenate[rtb_Product1_c_tmp] += rtb_Product1_i0[3 * i_0 + 2] * rtb_Product1_b[i + 6];
        }
    ...
    for (i_0 = 0;BitmapCov::CondAndMCDCRecord(BitmapCov::CondAndMCDCRecord(i_0 < 3, 12, 1, 6), -13, 0, 6);i_0++) {
        BitmapCov::branchBitmap[12] = 1;
        for (i = 0;BitmapCov::CondAndMCDCRecord(BitmapCov::CondAndMCDCRecord(i < 3, 14, 1, 7), -15, 0, 7);i++) {
            BitmapCov::branchBitmap[13] = 1;
            rtb_Product1_c_tmp = 3 * i_0 + i;
            rtb_Product1_i0[rtb_Product1_c_tmp] = 0.0;
            rtb_Product1_i0[rtb_Product1_c_tmp] += rtb_VectorConcatenate[3 * i_0] * rtb_Product1_b[i];
            rtb_Product1_i0[rtb_Product1_c_tmp] += rtb_VectorConcatenate[3 * i_0 + 1] * rtb_Product1_b[i + 3];
            rtb_Product1_i0[rtb_Product1_c_tmp] += rtb_VectorConcatenate[3 * i_0 + 2] * rtb_Product1_b[i + 6];
        }
    ...
    for (i_0 = 0;BitmapCov::CondAndMCDCRecord(BitmapCov::CondAndMCDCRecord(i_0 < 3, 16, 1, 8), -17, 0, 8);i_0++) {
        BitmapCov::branchBitmap[16] = 1;
        for (i = 0;BitmapCov::CondAndMCDCRecord(BitmapCov::CondAndMCDCRecord(i < 3, 18, 1, 9), -19, 0, 9);i++) {
            BitmapCov::branchBitmap[17] = 1;
            rtb_Product1_c_tmp = 3 * i_0 + i;
            rtb_Product[rtb_Product1_c_tmp] = 0.0;
            rtb_Product[rtb_Product1_c_tmp] += rtb_Product1_b[3 * i_0] * rtb_VectorConcatenate[i];
            rtb_Product[rtb_Product1_c_tmp] += rtb_Product1_b[3 * i_0 + 1] * rtb_VectorConcatenate[i + 3];
            rtb_Product[rtb_Product1_c_tmp] += rtb_Product1_b[3 * i_0 + 2] * rtb_VectorConcatenate[i + 6];
        }
    ...
    for (i_0 = 0;BitmapCov::CondAndMCDCRecord(BitmapCov::CondAndMCDCRecord(i_0 < 3, 20, 1, 10), -21, 0, 10);i_0++) {
        BitmapCov::branchBitmap[20] = 1;
        rtb_Product2_m[i_0] = 0.0;
        euler321_I2B_12B_Y_Vb[i_0] = 0.0;
        euler321_I2B_12B_Y_outGamma[i_0] = 0.0;
        for (i = 0;BitmapCov::CondAndMCDCRecord(BitmapCov::CondAndMCDCRecord(i < 3, 22, 1, 11), -23, 0, 11);i++) {
            BitmapCov::branchBitmap[21] = 1;
            rtb_Product1_c_tmp = 3 * i + i_0;
            rtb_Product1_b[rtb_Product1_c_tmp] = 0.0;
            rtb_Product1_b[rtb_Product1_c_tmp] += rtb_Product[3 * i] * rtb_VectorConcatenate[i_0];
            rtb_Product1_b[rtb_Product1_c_tmp] += rtb_Product[3 * i + 1] * rtb_VectorConcatenate[i_0 + 3];
            rtb_Product1_b[rtb_Product1_c_tmp] += rtb_Product[3 * i + 2] * rtb_VectorConcatenate[i_0 + 6];
            euler321_I2B_12B_Y_Vb[i_0] += euler321_I2B_12B_Y_DCM321[rtb_Product1_c_tmp] * euler321_I2B_12B_U_Vi[i];
            euler321_I2B_12B_Y_outGamma[i_0] += rtb_Product1_i0[rtb_Product1_c_tmp] * euler321_I2B_12B_U_Vi[i];
            rtb_Product2_m[i_0] += rtb_Product1_b[rtb_Product1_c_tmp] * euler321_I2B_12B_U_Vi[i];
        }
        BitmapCov::branchBitmap[22] = 1;
    }
    BitmapCov::branchBitmap[23] = 1;
    euler321_I2B_12B_Y_outTheta[0] = euler321_I2B_12B_Y_Vb[0] - euler321_I2B_12B_Y_outGamma[0];
    euler321_I2B_12B_Y_outTheta[1] = euler321_I2B_12B_Y_Vb[1] - euler321_I2B_12B_Y_outGamma[1];
    euler321_I2B_12B_Y_outTheta[2] = euler321_I2B_12B_Y_Vb[2] - euler321_I2B_12B_Y_outGamma[2];
    ...
    rtb_TrigonometricFunction2 = rtb_TrigonometricFunction4_tm_0 * rtb_TrigonometricFunction4_tmp;
    rtb_TrigonometricFunction4 = rtb_TrigonometricFunction2_tm_0 * rtb_TrigonometricFunction4_tmp;
    *euler321_I2B_12B_Y_outR1 = (BitmapCov::CondAndMCDCRecord((BitmapCov::CondAndMCDCRecord(rtb_TrigonometricFunction4_tm_0 * rtb_TrigonometricFunction2_tmp == euler321_I2B_12B_Y_DCM321[0], 24, 1, 12))&(BitmapCov::CondAndMCDCRecord(rtb_TrigonometricFunction2 * rtb_TrigonometricFunction2_tm_1 + -rtb_TrigonometricFunction4_tm_1 * rtb_TrigonometricFunction2_tm_0 == euler321_I2B_12B_Y_DCM321[1], 26, 2, 12))&(BitmapCov::CondAndMCDCRecord(rtb_TrigonometricFunction2 * rtb_TrigonometricFunction4_tm_1 + rtb_TrigonometricFunction2_tm_1 * rtb_TrigonometricFunction2_tm_0 == euler321_I2B_12B_Y_DCM321[2], 28, 3, 12))&(BitmapCov::CondAndMCDCRecord(rtb_TrigonometricFunction2_tm_0 * rtb_TrigonometricFunction2_tmp == euler321_I2B_12B_Y_DCM321[3], 30, 4, 12))&(BitmapCov::CondAndMCDCRecord(rtb_TrigonometricFunction4 * rtb_TrigonometricFunction2_tm_1 + rtb_TrigonometricFunction4_tm_0 * rtb_TrigonometricFunction4_tm_1 == euler321_I2B_12B_Y_DCM321[4], 32, 5, 12))&(BitmapCov::CondAndMCDCRecord(rtb_TrigonometricFunction4 * rtb_TrigonometricFunction4_tm_1 + -rtb_TrigonometricFunction2_tm_1 * rtb_TrigonometricFunction4_tm_0 == euler321_I2B_12B_Y_DCM321[5], 34, 6, 12))&(BitmapCov::CondAndMCDCRecord(-rtb_TrigonometricFunction4_tmp == euler321_I2B_12B_Y_DCM321[6], 36, 7, 12))&(BitmapCov::CondAndMCDCRecord(rtb_TrigonometricFunction2_tm_1 * rtb_TrigonometricFunction2_tmp == euler321_I2B_12B_Y_DCM321[7], 38, 8, 12))&(BitmapCov::CondAndMCDCRecord(rtb_TrigonometricFunction4_tm_1 * rtb_TrigonometricFunction2_tmp == euler321_I2B_12B_Y_DCM321[8], 40, 9, 12)), -25, 0, 12));
