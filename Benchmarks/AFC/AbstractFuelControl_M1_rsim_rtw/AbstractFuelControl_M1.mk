...
MODULES                 = rt_logging.c AbstractFuelControl_M1.c AbstractFuelControl_M1_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_zcfcn.c rsim_main.c rsim_sup.c rsim_mat.c simulink_solver_api.c rsim_utils.c common_utils.c rt_sim.c ode3.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)\AbstractFuelControl_M1.exe
MAKEFILE                = AbstractFuelControl_M1.mk
MATLAB_ROOT             = C:\AppInstall\Matlab
ALT_MATLAB_ROOT         = C:\APPINS~1\Matlab
START_DIR               = C:\HomeSpace\DateTest\SimulinkModels\Benchmarks\AFC
S_FUNCTIONS_LIB         = 
NUMST                   = 2
NCSTATES                = 7
BUILDARGS               =  RSIM_SOLVER_SELECTION=1 PCMATLABROOT="C:\\AppInstall\\Matlab" EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 RSIM_PARAMETER_LOADING=1 OPTS="-DRT -DRSIM_PARAMETER_LOADING -DTID01EQ=1"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 1
ALLOCATIONFCN           = 0
...
COMPILE_FLAGS_OTHER     = 
SYSTEM_LIBS             = /LIBPATH:"C:\AppInstall\Matlab\extern\lib\win64\microsoft" libmat.lib libmx.lib libut.lib libmwsl_fileio.lib libmwsl_simtarget_instrumentation.lib libmwi18n.lib libmwsigstream.lib libmwsl_AsyncioQueue.lib sf_runtime.lib
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = AbstractFuelControl_M1_ref.rsp
COMPILER_COMMAND_FILE     = AbstractFuelControl_M1_comp.rsp
