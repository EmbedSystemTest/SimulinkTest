...
RT_MODEL_regs_12B_T mainState;
int main(int argc, char *argv[]) {
    regs_12B_init(&mainState, &init_regs_12B_U_beta_adc_deg, &init_regs_12B_U_vtas_adc_kts, &init_regs_12B_U_lcv_cmd_fcs_dps, &init_regs_12B_U_hdg_des_deg, &init_regs_12B_U_mcv_cmd_fcs_dps, &init_regs_12B_U_alt_des_ft, &init_regs_12B_U_ncv_cmd_fcs_dps, &init_regs_12B_U_xcv_cmd_fcs_fps, &init_regs_12B_U_airspeed_des_fps, &init_regs_12B_U_hcv_cmd_fcs_fps, &init_regs_12B_U_lcv_fps_dps, &init_regs_12B_U_mcv_fcs_dps, &init_regs_12B_U_ncv_fcs_dps, &init_regs_12B_U_dcv_fcs_fps, &init_regs_12B_U_zcv_fcs_fps, &init_regs_12B_U_beta_dot, &init_regs_12B_Y_lcvdt_cmd_fcs_dps2, &init_regs_12B_Y_mcvdt_cmd_fcs_dps2, &init_regs_12B_Y_ncvdt_cmd_fcs_dps2, &init_regs_12B_Y_xcvdt_cmd_fcs_fps2, &init_regs_12B_Y_hcvdt_cmd_fcs_fps2);
    real_T exec_regs_12B_U_beta_adc_deg;
    real_T exec_regs_12B_U_vtas_adc_kts;
    real_T exec_regs_12B_U_lcv_cmd_fcs_dps;
    real_T exec_regs_12B_U_mcv_cmd_fcs_dps;
    real_T exec_regs_12B_U_ncv_cmd_fcs_dps;
    real_T exec_regs_12B_U_xcv_cmd_fcs_fps;
    real_T exec_regs_12B_U_hcv_cmd_fcs_fps;
    real_T exec_regs_12B_U_lcv_fps_dps;
    real_T exec_regs_12B_U_mcv_fcs_dps;
    real_T exec_regs_12B_U_ncv_fcs_dps;
    real_T exec_regs_12B_U_dcv_fcs_fps;
    real_T exec_regs_12B_U_zcv_fcs_fps;
    real_T exec_regs_12B_U_beta_dot;
    real_T exec_regs_12B_Y_lcvdt_cmd_fcs_dps2;
    real_T exec_regs_12B_Y_mcvdt_cmd_fcs_dps2;
    real_T exec_regs_12B_Y_ncvdt_cmd_fcs_dps2;
    real_T exec_regs_12B_Y_xcvdt_cmd_fcs_fps2;
    real_T exec_regs_12B_Y_hcvdt_cmd_fcs_fps2;
}